...
public class RegisterationConfirmationEmailSender(IFluentEmail fluentEmail) : EmailSenderBase(fluentEmail)
{
    protected override string GetSubject() => "Activate Your Realm - Verification Code";
